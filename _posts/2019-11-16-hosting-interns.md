...
I've always focused on being the possible best at technical matters but as I continued growing up, I learned to appreciate soft skills.
...
By the time that my organization (MSRC) has agreed to assign one intern, the v-team had grown to many more people than expected.

This winter, I had gotten confirmation that we could have a summer intern at the office \o/. We ended up hosting two interns during the summer which proved to be a very interesting experience.

Here I'm going to describe from the experience from my point of view. I'm skipping the recruitment as it was managed by the HR department in ---- with the affiliated universities.

### What do you offer?

I dropped out of university and started working professionally at the age of 18 so never had the chance to make an internship (for good or bad). However, I remember when I first joined my first company (Immunity Inc.), I was super excited because I was going to join one of th ecompanies with most experience in the field.

For the interns, I wanted to give them something that would make them as excited as I was when I first joined that company.

In the SSPL v-team, we had an interesting set of challenges that we could give to the interns so I wasn't very worried about full-filling that expectation.

Some people consider interns to be cheap labour, and, unfortunately for them, some people will treat them like that. To avoid falling in this trap, I used the criteria of chosing as many as possible of these for their projects:
- Used in production: enforcement of standards
- Open source: self-promotion and community contribution
- Usage of new technologies: learning
- Challenging beyond "just the task": learning
- Involved other people or teams: mentors

### Interview

At Microsoft, we usually do a round of 4 engineering interviews and this one wasn't any different.

These were the first interns that we were hosting at the office and the recruitment process was managed by HR. We've got some indications from HR on how to make the interviews.

I think these were interesting questions that were beyond what we usually do for full-time engineers.

The type of questions that were programmed by HR consisted on picking the engineers on things like
...
All the questions had to be memorized and asked in the same way to all the interviewees. The problem I usually have with these is that they are too broad and it's hard to distinguish if the answers have been premeditated or not.

For the technical interview, I like starting with a problem and hope that we can solve it together. At that time, I was working on immutable data structures in Rust and the flow of the interview I decided to use was something like:
- Do you know what is an immutable data structure?
- Where would you use one?
- Can you implement an immutable tree in the programming language of your preference?
- Can you optimize it a little more?
- What if I want to ...

This type of questions usually help me evaluate how a person reasons about problems and if the person is familiar with the topic, we can usually go deeper into it until I either run out of questions or the interviewee is challenged.

After the interview, I met with the other interviewers and compared our results. In our case, it was a tough decision as we had two very smart guys with motivation for learning new things but were unfamiliar with the technologies we wanted to use.
